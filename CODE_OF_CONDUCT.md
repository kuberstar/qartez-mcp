...
We pledge to make the Qartez community welcoming, safe, and equitable for all.
...
When an incident does occur, it is important to report it promptly. To report a possible violation, please email **issues@qartez.dev**. All reports will be handled with discretion.
